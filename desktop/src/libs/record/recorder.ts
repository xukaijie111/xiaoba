...
//@ts-ignore
import BaseRecorder from './base.js'
//@ts-ignore
import MP3Converter from './convertMP3/index.js'


export default class Recorder {
    cfg: Recorder.options
    audioCtx: AudioContext
    recorder: BaseRecorder
    constructor(cfg: Recorder.options) {
        this.cfg = cfg;
    ...
    async init() {
        try {
            ...
            this.recorder = new BaseRecorder(mediaNode);
    ...
    start() {
        ...
        this.recorder.node.addEventListener(`audioprocess`, this.handleAudioProcess)
    ...
    stop() {
        this.recorder.stop();
        this.recorder && this.recorder.node.removeEventListener('audioprocess', this.handleAudioProcess);
    }

    handleAudioProcess = (dataBuffer: unknown) => {
